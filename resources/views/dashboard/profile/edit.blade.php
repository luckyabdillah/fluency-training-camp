            ...
            <form action="/dashboard/profile" method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="Email" value="{{ old('email', $student->email) }}" required autocomplete="off">
                        @error('email')
                            <div class="invalid-feedback text-start">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" id="phone_number" placeholder="8XXXXXXXXXX" value="{{ old('phone_number', $student->phone_number) }}" required autocomplete="off">
                        </div>
                        @error('phone_number')
